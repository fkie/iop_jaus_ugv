...
#ifndef ILLUMINATIONPLUGIN_H
#define ILLUMINATIONPLUGIN_H

#include "urn_jaus_jss_ugv_PowerPlantManager/PowerPlantManagerService.h"
...
class DllExport PowerPlantManagerPlugin : public PluginInterface
{
public:
	PowerPlantManagerPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_ugv_PowerPlantManager::PowerPlantManagerService *p_my_service;
