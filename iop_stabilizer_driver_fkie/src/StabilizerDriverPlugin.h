...
#ifndef STABILIZERDRIVERPLUGIN_H
#define STABILIZERDRIVERPLUGIN_H

#include "urn_jaus_jss_ugv_StabilizerDriver/StabilizerDriverService.h"
...
class DllExport StabilizerDriverPlugin : public PluginInterface
{
public:
	StabilizerDriverPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_ugv_StabilizerDriver::StabilizerDriverService *p_my_service;
