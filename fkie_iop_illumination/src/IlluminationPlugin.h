...
#include "urn_jaus_jss_ugv_IlluminationService/IlluminationServiceService.h"
...
class DllExport IlluminationPlugin : public PluginInterface
{
public:
	IlluminationPlugin();
...
protected:
	urn_jaus_jss_ugv_IlluminationService::IlluminationServiceService *p_my_service;
