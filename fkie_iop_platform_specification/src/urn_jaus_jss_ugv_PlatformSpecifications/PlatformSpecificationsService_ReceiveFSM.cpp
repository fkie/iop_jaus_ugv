...
void PlatformSpecificationsService_ReceiveFSM::setupIopConfiguration()
{
    ...
    // ACKERMANN
    cfg.param<double>("specifics.ackermann.steering_angle_range", specifics_ackermann_steering_angle_range, specifics_ackermann_steering_angle_range, true,
    ...
    cfg.param<double>("specifics.ackermann.min_turn_radius", specifics_ackermann_min_turn_radius, specifics_ackermann_min_turn_radius, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
    ...
    cfg.param<double>("specifics.ackermann.wheel_separation", specifics_ackermann_wheel_separation, specifics_ackermann_wheel_separation, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
    ...
    cfg.param<double>("specifics.ackermann.drive_wheel_radius", specifics_ackermann_drive_wheel_radius, specifics_ackermann_drive_wheel_radius, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
    ...
    // SKIDSTEER
    cfg.param<double>("specifics.skidsteer.track_separation", specifics_skidsteer_track_separation, specifics_skidsteer_track_separation, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
    ...
    cfg.param<double>("specifics.skidsteer.drive_wheel_radius", specifics_skidsteer_drive_wheel_radius, specifics_skidsteer_drive_wheel_radius, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
        "[meter] Radius of the drive wheel (distance from center of the drive shaft to the outer edge of the drive wheel) in meters.",
        "Default: NAN");
    ...
    // INERTIAL
    cfg.param<double>("inertial.maximum_forward_speed", inertial_maximum_forward_speed, inertial_maximum_forward_speed, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
        "[meters per second]",
        "Default: NAN");
    ...
    cfg.param<double>("inertial.maximum_reverse_speed", inertial_maximum_reverse_speed, inertial_maximum_reverse_speed, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
        "[meters per second]",
        "Default: NAN");
    ...
    cfg.param<double>("inertial.maximum_rotational_speed", inertial_maximum_rotational_speed, inertial_maximum_rotational_speed, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
        "[radians per second]",
        "Default: NAN");
    ...
    cfg.param<double>("inertial.maximum_forward_acceleration", inertial_maximum_forward_acceleration, inertial_maximum_forward_acceleration, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
    ...
    cfg.param<double>("inertial.maximum_reverse_acceleration", inertial_maximum_reverse_acceleration, inertial_maximum_reverse_acceleration, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
        "[meters per second squared]",
        "Default: NAN");
    ...
    cfg.param<double>("inertial.maximum_forward_deceleration", inertial_maximum_forward_deceleration, inertial_maximum_forward_deceleration, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
        "[meters per second squared]",
        "Default: NAN");
    ...
    cfg.param<double>("inertial.maximum_reverse_deceleration", inertial_maximum_reverse_deceleration, inertial_maximum_reverse_deceleration, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
        "[meters per second squared]",
        "Default: NAN");
    ...
    // SPEC
    cfg.param<std::string>("spec.mobility_platform_name", spec_mobility_platform_name, spec_mobility_platform_name, true,
    ...
    cfg.param<double>("spec.static_pitch_over", spec_static_pitch_over, spec_static_pitch_over, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
        "[radians]",
        "Default: NAN");
    ...
    cfg.param<double>("spec.static_roll_over", spec_static_roll_over, spec_static_roll_over, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
        "[radians]",
        "Default: NAN");
    if (!std::isnan(spec_static_roll_over))
        report.getBody()->getPlatformData()->getPlatformSpec()->setStaticRollOver(spec_static_roll_over);
    cfg.param<double>("spec.vehicle_weight", spec_vehicle_weight, spec_vehicle_weight, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
        "[kilogram]",
        "Default: NAN");
    if (!std::isnan(spec_vehicle_weight))
        report.getBody()->getPlatformData()->getPlatformSpec()->setVehicleWeight(spec_vehicle_weight);
    cfg.param<double>("spec.approach_angle", spec_approach_angle, spec_approach_angle, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
    ...
    cfg.param<double>("spec.departure_angle", spec_departure_angle, spec_departure_angle, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
        "[radians] The angle formed by an imaginary line from the bottom of the tires to the center of the vehicle’s underside.",
        "Default: NAN");
    if (!std::isnan(spec_departure_angle))
        report.getBody()->getPlatformData()->getPlatformSpec()->setDepartureAngle(spec_departure_angle);
    cfg.param<double>("spec.break_over_angle", spec_break_over_angle, spec_break_over_angle, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
        "[radians] The angle formed by an imaginary line from the bottom of the tires to the center of the vehicle’s underside.",
        "Default: NAN");
